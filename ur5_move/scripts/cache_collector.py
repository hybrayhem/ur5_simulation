...
class CacheCollector(object):
  ...
  def __init__(self):
    ...
    rospy.init_node('cache_collector', anonymous=True)
...
def main():
  try:
    ...
    while(True):
      x, y, z, w = input("Enter three x,y,z and w value: ").split()
      cache_collector.go_to_pose_goal(float(x), float(y), float(z), float(w))
